...
#' @noRd
sample_r_density <- function(logp_fn, grad_fn, value_grad_fn, ndim, init, num_draws, num_warmup, seed, save_warmup, max_treedepth, target_accept, adaptation, mass_matrix_gamma, eigval_cutoff, progress) .Call(wrap__sample_r_density, logp_fn, grad_fn, value_grad_fn, ndim, init, num_draws, num_warmup, seed, save_warmup, max_treedepth, target_accept, adaptation, mass_matrix_gamma, eigval_cutoff, progress)
