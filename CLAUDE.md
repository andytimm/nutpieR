...
- Full sampling parameters: `num_draws`, `num_warmup`, `num_chains`, `cores`, `seed`, `max_treedepth`, `target_accept`, `init_mean`
...
### What's next
- `expand_vector` support (constrained parameter transforms via `param_constrain`)
- Documentation and vignettes
- R-universe setup for binary distribution
...
├── tests/testthat/
│   ├── test-nutpieR.R       # 69 tests covering compilation, sampling, diagnostics
...
- **Rust toolchain**: `rustc >= 1.85`, `cargo` (edition 2024)
...
- **DiagGradNutsSettings** (standard diagonal mass matrix NUTS)
